...
export function ProductsShowcase({
  ...
  return (
    <Index indexName={indexName} indexId={indexId}>
      ...
      <section
        className={classNames('py-4 laptop:py-10 container mx-auto', className)}
      >
        <Container>
          {title && (
            <h4 className="text-lg font-semibold tracking-[2px] uppercase mb-2 laptop:mb-4 laptop:ml-3">
              {title}
            </h4>
          )}
          <InfiniteHits
